    ...
    <>
      <header className="top-nav">
        ...
        <nav className="header-nav" aria-label="Primary navigation">
          ...
          <NavLink to="/network" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>Network</NavLink>
          <NavLink to="/alternatives" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>Alternatives</NavLink>
          <NavLink to="/disruptions" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>Disruptions</NavLink>
        ...
        <div className="top-nav-actions">
          ...
          <button type="button" className="header-login-button" onClick={() => navigate('/#login')}>
            Login
          </button>
        </div>
      </header>
